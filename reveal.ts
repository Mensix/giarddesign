...
function toggleExpanded() {
  ...
  const overlayClassesToRemove = isExpanded ? ['bg-gradient-to-b', 'from-transparent', 'to-[#DCC1AB]', 'z-[1]'] : ['z-0']
  ...
  photoElements.forEach((element) => {
    element.classList.remove(...photoClassesToAdd)
    element.classList.add(...photoClassesToRemove)
  })
